...
namespace MT.Common.Utility.Extension
{
    ...
    public static class StringExtension
    {
        ...
        {
            if ( str.Length != 14 && str.IsNumber() ) throw new Exception("字符串格式不正确");
        ...
        {
            if ( str.Length < 8 && str.IsNumber() ) throw new Exception("字符串格式不正确");
        ...
        public static string ChopLeft(this string str, int count=1)
        {
            if ( str == null )
                throw new ArgumentNullException("str");
        ...
        /// <param name="str">一个 System.String 引用</param>
        /// <param name="count">劈掉的字符个数</param>
        public static string ChopRight(this string str, int count=1)
        {
            if ( str == null )
                throw new ArgumentNullException("str");
        ...
        /// <param name="str">要进行反序列化的 JSON 字符串</param>
        /// <returns></returns>
        public static string SerializeObject(this string str)
        {
            if ( str.IsNullOrEmpty() )
                throw new ArgumentNullException("str");
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static string IfNullOrEmpty(this string str, Func<string> value)
        {
            if ( string.IsNullOrEmpty(str) )
                return value(); 
            return str;
