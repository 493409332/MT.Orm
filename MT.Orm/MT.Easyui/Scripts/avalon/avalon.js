...
require.config({
    ...
    paths: {
        ...
        my97: "Scripts/My97DatePicker/WdatePicker",
        SwLoad: "Scripts/SwfUpload/plugins/swfupload.queue",
        SwL: "Scripts/SwfUpload/swfupload",
        Swsp: "Scripts/SwfUpload/plugins/swfupload.speed"
    },
    shim: {
        jquery: {
            exports: "jquery"
        ...
        easyui: {
            deps: ["jquery", "css!Content/iconcss/icon.css" + "?bust=" + (new Date()).getTime(), "css!" + userthemes],
            exports: "easyui"
        }
        , easyui_lang_zh_CN: {
            deps: ["easyui"],
        ...
        Search: { deps: ["json2"], exports: "Search" },
        linq: {
            exports: "linq"
        },
        linq_jquery: {
