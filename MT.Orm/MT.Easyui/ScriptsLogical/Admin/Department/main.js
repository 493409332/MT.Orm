...
require(["avalon", "easyui", "easyui_lang_zh_CN", "jqueryAjax", "XiucaiEasyUIExtensions", "jqueryvalidate", "json2"], function ()
{
    ...
    formHtml += '</table><input id="ID" type="hidden" name="ID"/><input type="hidden" style="width: 280px;" id="GuID" name="GuID" /></form>';
    ...
    $(function ()
    {
        autoResize({ dataGrid: '#depGrid', gridType: 'treegrid', callback: mygrid.bindGrid, height: 20, width: 15 });
