...
require(["avalon", "easyui", "easyui_lang_zh_CN", "jqueryAjax", "XiucaiEasyUIExtensions", "jqueryvalidate", "linq_jquery", "Search", "json2"], function ()
{
    var lastIndex = 0;
    var btns;
    var nb;
    ...
    var formHTML = '<form id=xiucaiForm><table cellpadding=5 cellspacing=0 width=100% align="center" class="grid" border=0>'
                ...
                + '<td align="left"><input name=rolename type="text"  required="true" style="width:150px" class="txt03" id="txtrolename" /></td></tr><tr>'
                  + '<tr><td align="right">所属部门：</td><td><input type="text" required="true"  name="DepartmentId" style="width: 200px" id="txt_department" /></td></tr>'
                ...
                + '</table><input id="ID" type="hidden" name="ID" /><input type="hidden" style="width: 280px;" id="GuID" name="GuID" /></form>';
