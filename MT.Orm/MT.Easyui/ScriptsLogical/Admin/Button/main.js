...
require(["easyui", "jqueryAjax", "easyui_lang_zh_CN", "showICON", "Search", "json2"], function ()
{
    ...
    pform += '权限说明：</td><td><textarea name="remark" rows="3" name=remark style="width:200px;height:50px;" class="txt03" id="txtremark" /></td></tr></table><input id="ID" type="hidden" name="ID" /> <input type="hidden" style="width: 280px;" id="GuID" name="GuID" /></form>';
